...
<div class="container">
	...
	<ul class="pagination justify-content-center">
		...
		<li class="page-item ${boards.first ? isDisabled : isNotDisabled }"><a class="page-link" href="?q=${q}&page=${boards.number-1}">Previous</a></li>
		...
		<li class="page-item ${boards.last ? isDisabled : isNotDisabled }"><a class="page-link" href="?q=${q}&page=${boards.number+1}">Next</a></li>
